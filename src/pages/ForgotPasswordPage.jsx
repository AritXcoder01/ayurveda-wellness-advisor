...
import { Mail, KeyRound, Lock, ArrowLeft, ArrowRight, ShieldCheck, CheckCircle2, AlertCircle, FolderOpen } from 'lucide-react';
      ...
      <div className="glass-card" style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1.5rem' }}>
          ...
          <button
            ...
            onClick={() => {
              refreshEmailLogs();
              setShowDirectoryDrawer(!showDirectoryDrawer);
            }}
            style={{
          ...
          >
            <FolderOpen size={14} /> Email Directory ({emailLogs.length})
          </button>
        </div>
        ...
        {/* Live Email Directory Drawer */}
        {showDirectoryDrawer && (
          <div style={{
            background: 'rgba(249, 251, 242, 0.95)',
            border: '1.5px solid #BAE164',
            borderRadius: '16px',
            padding: '1rem',
            marginBottom: '1.5rem',
            ...
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '0.75rem' }}>
              <span style={{ fontSize: '0.82rem', fontWeight: 800, color: '#1A3323', textTransform: 'uppercase' }}>
                📬 Live Email Directory Log
              </span>
              <span style={{ fontSize: '0.75rem', color: '#B86B18', fontWeight: 800 }}>Spotify-Style Inspection</span>
            </div>

            {emailLogs.length === 0 ? (
              <p style={{ fontSize: '0.8rem', color: '#7E9E88', textAlign: 'center', padding: '1rem 0' }}>
                No email dispatch logs yet. Request a code to view directory updates.
              </p>
            ) : (
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.6rem' }}>
                {emailLogs.map((log, index) => (
                  <div key={log.id || index} style={{
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', color: '#7E9E88', marginTop: '0.2rem', fontSize: '0.75rem' }}>
                      <span>Purpose: {log.purpose || 'Verification'}</span>
        ...
        {step === 2 && (
          <form onSubmit={handleVerifyCode}>
            ...
            {emailPreviewUrl && (
              <div style={{ fontSize: '0.8rem', color: '#567360', marginBottom: '1rem', textAlign: 'center' }}>
                📬 Test Inbox Preview:{' '}
                <a href={emailPreviewUrl} target="_blank" rel="noreferrer" style={{ color: '#B86B18', fontWeight: 800, textDecoration: 'underline' }}>
                  Click to View Dispatched Email
                </a>
              </div>
            )}
